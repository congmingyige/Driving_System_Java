				...
				if (car.ifcorrect(
					...
					if (mode==1) { //create
						...
						for (car_index=1;car_index<=Driving_System.car_count;car_index++)
							if (Driving_System.car[car_index].getNumber_plate().equals(text_number_plate.getText()) 
								&& Driving_System.car[car_index].getCar_iden_id().equals(text_car_iden_id.getText()))
								break;
