...
class Car {
	...
	public String setMySQL() {
		return "insert into car_table values('"+
			...
			image_path.trim()+"','"+Double.toString(speed_currency).trim()+"','"+Double.toString(speed_limite).trim()+"','"+
			...
			Double.toString(vehicle_kilometer).trim()+"','"+Double.toString(car_coefficient).trim()+"')";
	}
