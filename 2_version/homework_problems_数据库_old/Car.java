...
//		System.out.println(str);
	...
	public String updateTable() {
		String str="update CAR set "+
			"car_type='"+car_type.trim()+"',"+
			"person='"+person.trim()+"',"+
			"address='"+address.trim()+"',"+
			"engine_number='"+engine_number.trim()+"',"+
			"PD_yy="+Integer.toString(PD_yy).trim()+","+
			"PD_mm="+Integer.toString(PD_mm).trim()+","+
			"PD_dd="+Integer.toString(PD_dd).trim()+","+
			"image_path='"+image_path.replace("\\","\\\\").trim()+"',"+
			"speed_currency="+Double.toString(speed_currency).trim()+","+
			"speed_limite="+Double.toString(speed_limite).trim()+","+
			"weight="+Double.toString(weight).trim()+","+
			"load_currency="+Double.toString(load_currency).trim()+","+
			"load_limite="+Double.toString(load_limite).trim()+","+
			"oil_currency="+Double.toString(oil_currency).trim()+","+
			"oil_limite="+Double.toString(oil_limite).trim()+","+
			"oil_ave_use="+Double.toString(oil_ave_use).trim()+","+
			"vehicle_kilometer="+Double.toString(vehicle_kilometer).trim()+","+
			"car_coefficient="+Double.toString(car_coefficient).trim()+
			" where "+
			"number_plate='"+number_plate.trim()+"' and "+
			"car_iden_id='"+car_iden_id.trim()+"'";
//		System.out.println(str);
		return str;
	}
