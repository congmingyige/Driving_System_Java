				...
				if (driver.ifcorrect(
					...
					if (mode==1) { //create	
						...
						for (driver_index=1;driver_index<=Driving_System.driver_count;driver_index++)
							if (Driving_System.driver[driver_index].getName().equals(text_name.getText())
								&& Driving_System.driver[driver_index].getFile_number().equals(text_file_number.getText()))
								break;
