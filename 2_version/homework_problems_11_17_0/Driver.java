...
public class Driver {
	...
	Driver(String name, String nationality, String addr, String driving_type,
			int birth_yy, int birth_mm, int birth_dd,
		...
		this.name=name; this.nationality=nationality; this.addr=addr; this.driving_type=driving_type;
		this.birth_yy=birth_yy; this.birth_mm=birth_mm; this.birth_dd=birth_dd;
	...
	public boolean equals(Driver d) {
		return name.equals(d.name) && nationality.equals(d.nationality) && addr.equals(d.addr) && driving_type.equals(d.driving_type)
			&& birth_yy==d.birth_yy && birth_mm==d.birth_mm && birth_dd==d.birth_dd
...
//(int birth_yy, int birth_mm, int birth_dd){this.birth_yy=birth_yy; this.birth_mm=birth_mm; this.birth_dd=birth_dd;}
	...
	public void getDatasheet(ResultSet rs) throws SQLException {
		name=rs.getString(1);
	...
	public String setDatasheet() {
		...
		String str="insert into DRIVER values('"+
			...
			driving_type.trim()+"','"+Integer.toString(first_rece_yy).trim()+"','"+Integer.toString(first_rece_mm).trim()+"','"+Integer.toString(first_rece_dd).trim()+"','"+
			Integer.toString(valid_yy).trim()+"','"+Integer.toString(valid_mm).trim()+"','"+Integer.toString(valid_dd).trim()+"','"+
			Integer.toString(valid_time).trim()+"','"+file_number.trim()+"','"+image_path.trim()+"')";
